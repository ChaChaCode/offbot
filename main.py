...
async def start(message: types.Message):
    ...
    if subscribed:
        ...
        subscribe_button = InlineKeyboardButton(text="Подписаться", url="https://t.me/off_street")
        get_code_button = InlineKeyboardButton(text="Получить промокод", callback_data="get_code")
        keyboard.add(subscribe_button, get_code_button)
        ...
        # Если пользователь не подписан, отправляем сообщение о подписке с фотографией
